...
export async function generateContractPdf(data: ContractData): Promise<Buffer> {
  ...
  const sections: PdfSection[] = [
    ...
    { type: "paragraph", content: `2.3 O CONTRATANTE permanece com o direito da quota de posse e usufruto enquanto pague mensalmente e de forma antecipada à EXCLUSIVE CLUB a quantia de ${clause23monthlyText}, doravante designada "taxa mensal" (ou "taxas mensais", no plural), com reajuste anual de acordo com o IPCA.` },
    { type: "paragraph", content: `2.4 A taxa mensal é cobrada de forma antecipada: o CONTRATANTE paga primeiro para ter o direito de uso da embarcação no mês correspondente — não usa para poder pagar. A 1ª taxa mensal vence no mesmo dia do mês-calendário imediatamente seguinte ao do pagamento da taxa inicial. As demais taxas mensais vencem no mesmo dia de cada um dos meses-calendário seguintes. Está sujeito às disposições das cláusulas 2.6 e 2.7.` },
