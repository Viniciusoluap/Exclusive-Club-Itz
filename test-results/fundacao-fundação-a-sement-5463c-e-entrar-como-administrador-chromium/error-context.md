...
- Name: fundacao.spec.ts >> fundação >> a semente entra e o robô consegue entrar como administrador
...
Locator: getByText('Diagnóstico do Sistema')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Diagnóstico do Sistema')
